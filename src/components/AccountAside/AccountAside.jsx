...
const AccountAside = ({ loggedUser, profileMenu, setProfileMenu, userSignOut }) => {
                ...
                {profileMenu &&
                    <motion.aside key={profileMenu}
                        ...
                        <div className="aside-content align-items-center">
                            {auth?.currentUser ? (<img className='w-50 h-50 border rounded-circle' src={auth?.currentUser?.photoURL} alt="logo" />) :
