        ...
        <div className="order-price container py-3">
            ...
            <form action="">
                <div className="row">
                    ...
                    <div data-aos="fade-right" className="form-element col-12 col-md-6"><input type="text" placeholder='Adınız' name="name" className='sign-inputs' required /></div>
                    <div data-aos="fade-right" className="form-element col-12 col-md-6"><input type="text" placeholder='Şirkətin adı' name="company" className='sign-inputs' required /></div>
                    {change ? (<div data-aos="fade-right" className="form-element col-12 col-md-6">
                        <InputMask
